...
/** HelloWorld
  * An application with three maps side-by-side zoomed in on different locations.
  * Author: UC San Diego Coursera Intermediate Programming team
  * @author Filip Dostál
  * Date: July 17, 2015
  * */
public class HelloWorld_test extends PApplet
{
	...
	/** The map you will use to display your current town */ 
	UnfoldingMap map3;
	...
	public void setup() {
	    ...
	    map2.zoomAndPanTo(zoomLevel, new Location(49.59f, 17.25f));
	    map3.zoomAndPanTo(zoomLevel, new Location(25.0f, 121.5f));
	    //25.0f, 121.5f Taipei
	    //49.595547, 17.251740 Olomouc
